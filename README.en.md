...
**Not sure which Mac you have?** Apple menu → About This Mac. If the window shows a
**Chip** line (an M-series chip), take the `arm64` build. If it shows a **Processor** line
naming an Intel Core, take the other one.
